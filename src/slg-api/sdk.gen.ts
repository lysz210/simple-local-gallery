...
import type { GetPhotosSummaryData, GetPhotosSummaryResponses, SearchPhotosData, SearchPhotosResponses, SearchPhotosErrors, GetPhotoByIdData, GetPhotoByIdResponses, GetPhotoByIdErrors, PatchPhotoData, PatchPhotoResponses, PatchPhotoErrors, UpdatePhotoPointData, UpdatePhotoPointResponses, UpdatePhotoPointErrors, ImportPhotosData, ImportPhotosResponses, ImportPhotosErrors, GetGalleryRootData, GetGalleryRootResponses, ResetGalleryRootData, ResetGalleryRootResponses, GetTracksSummaryData, GetTracksSummaryResponses, InspectGpxFileData, InspectGpxFileResponses, InspectGpxFileErrors, ImportPgxFileData, ImportPgxFileResponses, ImportPgxFileErrors, LocatePhotoOnTrackData, LocatePhotoOnTrackResponses, LocatePhotoOnTrackErrors, GetFilesystemSummaryData, GetFilesystemSummaryResponses, FindPhotosData, FindPhotosResponses, FindPhotosErrors, FindGpxFilesData, FindGpxFilesResponses, ClearThumbnailsCacheData, ClearThumbnailsCacheResponses, InpectPhotoData, InpectPhotoResponses, InpectPhotoErrors, LoginData, LoginResponses, PhotoInfoData, PhotoInfoResponses, PhotoInfoErrors, UpdatePhotoInfoData, UpdatePhotoInfoResponses, UpdatePhotoInfoErrors } from './types.gen';
...
export class Photos {
     ...
     * Search Photos
     */
    public static searchPhotos<ThrowOnError extends boolean = false>(options?: Options<SearchPhotosData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<SearchPhotosResponses, SearchPhotosErrors, ThrowOnError>({
            responseType: 'json',
     ...
     * Patch Photo
     */
    public static patchPhoto<ThrowOnError extends boolean = false>(options: Options<PatchPhotoData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).patch<PatchPhotoResponses, PatchPhotoErrors, ThrowOnError>({
            responseType: 'json',
            url: '/api/v1/photos/{id}',
            ...options,
            headers: {
     ...
     * Update Photo Point
     */
    public static updatePhotoPoint<ThrowOnError extends boolean = false>(options: Options<UpdatePhotoPointData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).put<UpdatePhotoPointResponses, UpdatePhotoPointErrors, ThrowOnError>({
            responseType: 'json',
...
export class Tracks {
    ...
    public static locatePhotoOnTrack<ThrowOnError extends boolean = false>(options: Options<LocatePhotoOnTrackData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<LocatePhotoOnTrackResponses, LocatePhotoOnTrackErrors, ThrowOnError>({
            responseType: 'json',
...
export class Ai {
    /**
     * Inspect Photo With Genai
     */
    public static inpectPhoto<ThrowOnError extends boolean = false>(options: Options<InpectPhotoData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<InpectPhotoResponses, InpectPhotoErrors, ThrowOnError>({
            responseType: 'json',
...
export class Flickr {
    ...
    public static login<ThrowOnError extends boolean = false>(options?: Options<LoginData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<LoginResponses, unknown, ThrowOnError>({
            responseType: 'json',
     ...
     * Photo Info
     */
    public static photoInfo<ThrowOnError extends boolean = false>(options: Options<PhotoInfoData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<PhotoInfoResponses, PhotoInfoErrors, ThrowOnError>({
            responseType: 'json',
    ...
    /**
     * Update Flickr Photo Info
     */
    public static updatePhotoInfo<ThrowOnError extends boolean = false>(options: Options<UpdatePhotoInfoData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<UpdatePhotoInfoResponses, UpdatePhotoInfoErrors, ThrowOnError>({
            responseType: 'json',
