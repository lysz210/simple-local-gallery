...
import type { LoginData, LoginResponse, PhotoInfoData, PhotoInfoError, PhotoInfoResponse, UpdatePhotoInfoData, UpdatePhotoInfoError, UpdatePhotoInfoResponse } from '../../types.gen';
 ...
 */
export const updatePhotoInfoMutation = (options: Options<UpdatePhotoInfoData>): UseMutationOptions<UpdatePhotoInfoResponse, Options<UpdatePhotoInfoData>, AxiosError<UpdatePhotoInfoError>> => {
    return {
